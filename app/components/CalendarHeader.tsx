...
export const CalendarHeader = () => {
  ...
  return (
    <nav className="flex justify-between mb-2 border-b border-violet-100 dark:border-gray-700 p-4">
      <h1 className="font-bold text-2xl dark:text-gray-200 ">Calendar</h1>
      <button
        className="toggle-dark-button rounded-full p-2 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none"
        title="Toggle dark mode"
        onClick={toggleDarkMode}
      >
        {!darkMode ? (
          <svg className="light h-6 w-6" focusable="false" viewBox="0 0 32 32">
            <path
          ...
          <svg className="dark h-6 w-6" focusable="false" viewBox="0 0 32 32">
            <path
