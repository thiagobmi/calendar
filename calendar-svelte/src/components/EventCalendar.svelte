<script lang="ts">
    // Import the modular version of the library as you were doing before
    ...
    // Include all the plugins you need
    let plugins = [
      TimeGrid,
      ResourceTimeGrid,
      ResourceTimeline,
    ...
    // Set up options to match the demo
    let options = {
      view: 'timeGridWeek',
      headerToolbar: {
  ...
  <div class:ec-dark={darkMode} class="w-full">
    <header class="flex flex-row items-center justify-between p-4">
      <h4 class="text-lg font-semibold"><a href="https://github.com/vkurko/calendar" class="hover:underline">Event Calendar</a> Demo</h4>
      <button 
